...
final class RemovePersonFromListArgumentResolver extends AbstractArgumentResolver
{
    public function supports(Request $request, ArgumentMetadata $argument): bool
    {
        return RemovePersonFromList::class === $argument->getType();
    }
    ...
    public function resolve(Request $request, ArgumentMetadata $argument): Generator
    {
        ...
        yield new RemovePersonFromList(UuidV4::fromString($data['list']), UuidV4::fromString($data['person']));
    }
